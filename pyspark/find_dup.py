...
employee_data = [
    ...
    (10, "john doe", 30, "Engineering", 75000.0)
...
Window=Window.partitionBy("id").orderBy(col("salary"))
ranked_df=emp_df.withColumn("rank",dense_rank().over(Window))
dup_df=ranked_df.filter(col("rank") > 1)
dup_df.show()